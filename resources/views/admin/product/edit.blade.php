    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 p-2">
            <div>
                ...
                <p class="text-sm text-gray-500 dark:text-gray-400">Modifica los detalles del producto</p>
            </div>
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <textarea name="description" id="description" rows="4"
                                    class="beauty-input block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm focus:border-pink-500 focus:ring-pink-500 dark:bg-gray-800 dark:text-white sm:text-sm">{{ old('description', $product->description) }}</textarea>
                            </div>
                            @error('description')
                            <p class="mt-1 text-sm text-red-600 dark:text-red-400">{{ $message }}</p>
                            @enderror
                            ...
                            <div
                                ...
                                <div class="space-y-1 text-center">
                                    <div class="flex flex-col items-center">
                                        @if($product->image)
                                        <div id="image-preview" class="mb-3 overflow-hidden rounded-md">
                                            <img id="preview-img" src="{{ asset('storage/' . $product->image) }}" alt="Vista previa"
